...
<?php        
        ...
        $pdo = new PDO('mysql:host=localhost;dbname=id13307111_dnd','id13307111_root','177300Milan!');
...
<div id="retainers-table" class="">
    ...
    <?php
            ...
            $sql = "SELECT `Source Name` FROM `Sources` WHERE `id` LIKE $sourceid";
            $result2 = $mysqli->query($sql);
            $row2 = $result2->fetch_assoc();
            $sourcename = $row2['Source Name'];
