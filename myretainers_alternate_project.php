...
<a href="create_retainer.php" class="btn btn-primary btn-xs pull-right col-12 col-md-6"><b>+</b> Add new retainer</a>
...
<div class="row">
-->
<div id="retainers-table" style="margin:1rem;">
...
<!--table table-striped custab col-lg-10 col-md-11 col-xs-12-->
    ...
    <tr id=<?php echo '"'.$retainer_id.'"'?>>
                <td class="details-control"><?php echo $retainername; ?></td>
                <td class="details-control"><?php echo $type; ?></td>
                <td class="details-control"><?php echo $assoc_character; ?></td>
                
    </tr> 
    
        <?php 
        $viewlink = 'retainer.php?id='.$retainer_id;
        $editlink = 'edit_retainer_form.php?id='.retainer_id;
        $deletelink = 'delete.php?id='.retainer_id;        
        ?>
<!--
             echo 
...
$(document).ready(function() {
 ...
 var table = $('#myretainertable').DataTable();
...
$('#myretainertable tbody').on('click', 'td.details-control', function () {
